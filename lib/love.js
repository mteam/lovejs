...
var eventify, getCode, getName, i, keyDown, keyUp, keyboard, letter, names, pressed, _i, _j, _k, _len, _ref;
...
var eventify, getButton, getOffset, getPosition, graphics, mouse, pos, pressed, updatePosition;
...
mouse.wheel = function(event) {
  ...
  return mouse.trigger('mouseDown', button, pos.x, pos.y);
};
